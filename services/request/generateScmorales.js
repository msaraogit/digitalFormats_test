const { Model, Manager, Contact, ProductService, EndorsementData } = require("../../models/sao/request/scmoralesRequest");
...
function fillModel() {
  const managers = [
      new Manager('Jose Alberto Vazquez Hernandez', 'Director', 'VAHA750319MZA', 'mvelazquez@scosi.mx', '9 años'),
      new Manager('Edgar Vázquez Hernández', 'Director', undefined, undefined, '9 años')
  ];

  const contacts = [
      new Contact('Cobranza', 'Jose Alberto Vazquez Hernandez', 'Director', '4424718971', 'mvelazquez@scosi.mx'),
      new Contact('Negocios', 'Edgar Vázquez Hernández', 'Director', '4424718971', 'mvelazquez@scosi.mx'),
      new Contact('Aclaraciones', 'Jose Alberto Vazquez Hernandez', 'Director', '4424718971', 'mvelazquez@scosi.mx')
  ];

  const productsServices = [
      new ProductService('Comercio al por mayor de equipo y material eléctrico', '100%', '1%')
  ];
